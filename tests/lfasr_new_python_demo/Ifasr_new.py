...
if __name__ == '__main__':
    # 单个语音文件解析并保存
    speechpath = "audio/wav"
    # speechpath = "audio/lfasr_涉政"
    save_path = speechpath + '.txt' # txt与mp3同名，并保存在同一路径下
    # fw = open(save_path, 'w')

    # 解析语音并保存到txt
    api = RequestApi(appid="013c3cdb", secret_key="2a0a119701adde67d094969c40c0b991", upload_file_path=speechpath+".wav")
    content = api.all_api_request()
    print(content)
